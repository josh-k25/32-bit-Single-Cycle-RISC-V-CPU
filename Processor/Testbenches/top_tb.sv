...
$fatal(1,
    "addi failed! expected pc = 4 and x1 = 5, got pc = %0d and x1 = %0d.",
    dut.pc,
...
$fatal(1,
    "sw signals failed! expected memoryWrite = 1, dataAddress = 4, and writeData = 5, got memoryWrite = %b, dataAddress = %0d, and writeData = %0d.",
    memoryWrite,
    dataAddress,
    writeData
);
...
$fatal(1,
    "sw failed! expected pc = 8 and memory[1] = 5, got pc = %0d and memory[1] = %0d.",
    dut.pc,
...
if (dut.pc !== 32'd72)
$fatal(1,
    "halt failed! expected pc = 72, got pc = %0d.",
    dut.pc
);

$display(
    "All tests passed successfully. memory[18] = %0d.",
    dut.dataMemory.memory[18]
);
